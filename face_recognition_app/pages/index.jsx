...
const Home = () => {
  ...
  const [hasAttendance, setAttendance] = React.useState(false);
          ...
          <div>
            ...
            >
              ...
              <div className="absolute left-8 top-8 justify-center">
                {isCheckIn ? (
                  <div className="bg-blue-500/[.8] font-[Montserrat] text-white px-4 py-2 text-[14px] rounded-lg ">
                    Check in
                  </div>
                ) : (
                  <div className="bg-red-500/[.8] font-[Montserrat] text-white px-4 py-2 text-[14px] rounded-lg ">
                    Check out
                  </div>
                )}
              </div>
